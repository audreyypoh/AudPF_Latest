  ...
  const projects = [
    {
      ...
      image: "https://images.unsplash.com/photo-1758686254415-9348b5b5df01?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxyZXRpcmVtZW50JTIwcGxhbm5pbmclMjBjb3VwbGV8ZW58MXx8fHwxNzYyMjg0MjcxfDA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1758686254415-9348b5b5df01?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxmYW1pbHklMjBmaW5hbmNpYWwlMjBwbGFubmluZ3xlbnwxfHx8fDE3NjIyMDA2OTN8MA&ixlib=rb-4.1.0&q=80&w=1080",
    ...
    },
    {
      ...
      image: "https://images.unsplash.com/photo-1460925895917-afdab827c52f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnZlc3RtZW50JTIwcG9ydGZvbGlvfGVufDF8fHx8MTc2MjIyMjI0NHww&ixlib=rb-4.1.0&q=80&w=1080",
              ...
              <Card className="h-full flex flex-col overflow-hidden border-border hover:border-foreground/30 transition-all bg-background/80">
                <div className="aspect-video overflow-hidden border-b border-border relative">
                  <Image
                    ...
                    alt={project.title}
                    fill
                    className="object-cover hover:opacity-80 transition-opacity duration-500 grayscale hover:grayscale-0"
                  />
                </div>
                <CardHeader>
